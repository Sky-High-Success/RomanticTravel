...
function social_facebook($atts, $content) {
	...
	$return_html = '<div class="social-image"><a class="facebook-icon" href="'.$url.'"><img src="' . get_stylesheet_directory_uri() . '/images/social/facebook.png" alt="facebook"/></a></div>';
...
function social_behance($atts, $content) {
	...
	$return_html = '<div class="social-image"><a class="behance-icon" class="social-image" href="'.$url.'"><img src="' . get_stylesheet_directory_uri() . '/images/social/behance.png" alt="behance"/></a></div>';
...
function social_dribbble($atts, $content) {
	...
	$return_html = '<div class="social-image"><a class="dribbble-icon" class="social-image" href="'.$url.'"><img src="' . get_stylesheet_directory_uri() . '/images/social/dribbble.png" alt="dribbble"/></a></div>';
...
function social_envato($atts, $content) {
	...
	$return_html = '<div class="social-image"><a class="social-image" href="'.$url.'"><img src="' . get_stylesheet_directory_uri() . '/images/social/envato.png" alt="envato"/></a></div>';
...
function social_evernote($atts, $content) {
	...
	$return_html = '<div class="social-image"><a class="evernote-icon" class="social-image" href="'.$url.'"><img src="' . get_stylesheet_directory_uri() . '/images/social/evernote.png" alt="evernote"/></a></div>';
...
function social_flickr($atts, $content) {
	...
	$return_html = '<div class="social-image"><a class="flickr-icon" class="social-image" href="'.$url.'"><img src="' . get_stylesheet_directory_uri() . '/images/social/flickr.png" alt="flickr"/></a></div>';
...
function social_forrst($atts, $content) {
	...
	$return_html = '<div class="social-image"><a class="forrst-icon" class="social-image" href="'.$url.'"><img src="' . get_stylesheet_directory_uri() . '/images/social/forrst.png" alt="forrst"/></a></div>';
...
function social_google($atts, $content) {
	...
	$return_html = '<div class="social-image"><a class="google-icon" class="social-image" href="'.$url.'"><img src="' . get_stylesheet_directory_uri() . '/images/social/google.png" alt="google"/></a></div>';
...
function social_googleplus($atts, $content) {
	...
	$return_html = '<div class="social-image"><a class="googleplus-icon" class="social-image" href="'.$url.'"><img src="' . get_stylesheet_directory_uri() . '/images/social/googleplus.png" alt="google+"/></a></div>';
...
function social_gowalla($atts, $content) {
	...
	$return_html = '<div class="social-image"><a class="gowalla-icon" class="social-image" href="'.$url.'"><img src="' . get_stylesheet_directory_uri() . '/images/social/gowalla.png" alt="gowalla"/></a></div>';
...
function social_icloud($atts, $content) {
	...
	$return_html = '<div class="social-image"><a class="icloud-icon" class="social-image" href="'.$url.'"><img src="' . get_stylesheet_directory_uri() . '/images/social/icloud.png" alt="icloud"/></a></div>';
...
function social_linkedin($atts, $content) {
	...
	$return_html = '<div class="social-image"><a class="linkedin-icon" class="social-image" href="'.$url.'"><img src="' . get_stylesheet_directory_uri() . '/images/social/linkedin.png" alt="linkedin"/></a></div>';
...
function social_paypal($atts, $content) {
	...
	$return_html = '<div class="social-image"><a class="paypal-icon" class="social-image" href="'.$url.'"><img src="' . get_stylesheet_directory_uri() . '/images/social/paypal.png" alt="paypal"/></a></div>';
...
function social_pinterest($atts, $content) {
	...
	$return_html = '<div class="social-image"><a class="pinterest-icon" class="social-image" href="'.$url.'"><img src="' . get_stylesheet_directory_uri() . '/images/social/pinterest.png" alt="pinterest"/></a></div>';
...
function social_rss($atts, $content) {
	...
	$return_html = '<div class="social-image"><a class="rss-icon" class="social-image" href="'.$url.'"><img src="' . get_stylesheet_directory_uri() . '/images/social/rss.png" alt="rss"/></a></div>';
...
function social_tumblr($atts, $content) {
	...
	$return_html = '<div class="social-image"><a class="tumblr-icon" class="social-image" href="'.$url.'"><img src="' . get_stylesheet_directory_uri() . '/images/social/tumblr.png" alt="tumblr"/></a></div>';
...
function social_twitter($atts, $content) {
	...
	$return_html = '<div class="social-image"><a class="twitter-icon" class="social-image" href="'.$url.'"><img src="' . get_stylesheet_directory_uri() . '/images/social/twitter.png" alt="twitter"/></a></div>';
...
function social_vimeo($atts, $content) {
	...
	$return_html = '<div class="social-image"><a class="vimeo-icon" class="social-image" href="'.$url.'"><img src="' . get_stylesheet_directory_uri() . '/images/social/vimeo.png" alt="vimeo"/></a></div>';
...
function social_wordpress($atts, $content) {
	...
	$return_html = '<div class="social-image"><a class="wordpress-icon" class="social-image" href="'.$url.'"><img src="' . get_stylesheet_directory_uri() . '/images/social/wordpress.png" alt="wordpress"/></a></div>';
...
function social_youtube($atts, $content) {
	...
	$return_html = '<div class="social-image"><a class="youtube-icon" class="social-image" href="'.$url.'"><img src="' . get_stylesheet_directory_uri() . '/images/social/youtube.png" alt="youtube"/></a></div>';
